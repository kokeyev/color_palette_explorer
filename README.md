...
Можете прочитать <a href = "https://medium.com/@Ikay_codes/flutter-web-build-your-first-flutter-web-app-9d100b977fc3"> этот артикл </a> для детальной загрузки flutter web
